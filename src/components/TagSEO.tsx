...
const defaults = {
  ...
  og: {
    title: `GWA to GPA (4.0 Scale) Converter & Calculator - Philippines GWA to 4.0 GPA`,
    description:
      "his is an open-source, tool to help convert GWA to GPA. The tool converts GWA (Philippines) to GPA (4.0 scale)",
